<?php 
/**
* SEG_ed_crear_accion.php
*
* inserta el registro de una nueva acción, vinculada a un seguimiento existente.
* 
...
if(!isset($_POST['idseg'])){
    $Log['tx'][]=utf8_encode('no se envío la variable idseg');
    $Log['res']='err';
    terminar($Log); 
}
...
$Log['data']['nidacc']=$Conec1->insert_id;

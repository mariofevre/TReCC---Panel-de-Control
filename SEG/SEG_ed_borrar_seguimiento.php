<?php 
/**
* SEG_ed_borrar_seguimiento.php
*
* modifica los atributos de un seguimiento para que sea identificado como eliminado. (dejará de ser devuelto por las consultas habituales)
* 

<?php 
/**
* SEG_ed_desuspender_accion.php
*
* actualiza los atributos de una accion en la base de datos para que deje de ser considerada en suspensión o hibernación. 
* 
